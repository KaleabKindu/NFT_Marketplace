    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button variant="ghost" className="rounded-full relative">
          {unReadCount > 0 && <Badge className="absolute inline-flex items-center justify-center w-6 h-6 text-xs font-bold border-2 border-green rounded-full -top-1 -end-1 dark:border-gray-900 bg-primary  text-white" variant="outline" >{unReadCount} </Badge>}
