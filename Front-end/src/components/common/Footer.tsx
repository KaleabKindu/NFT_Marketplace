      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-5 py-5 lg:py-10 mt-5 lg:mt-10 border-t">
        ...
        <div className="flex flex-col justify-between max-w-[70%] lg:max-w-full mx-auto">
          ...
          <div className="flex flex-col gap-5">
            <div className="p-3">
              The Largest NFT Marketplace for Digital Products. Buy, Sell and
              Discover Exclusive Digital Products as Non-Fungible Token(NFTs){" "}
            </div>
        ...
        <div className="flex flex-col gap-5 items-center p-2">
          ...
          {discover.map((option, index) => (
            <Link
              className="w-[40%] text-center rounded-md py-1 hover:bg-accent"
              href="/"
              key={index}
            >
              {option.name}
